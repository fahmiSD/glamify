                        ...
                        <div class="col-span-3 p-2">
                          ...
                          <form action="">
                            <textarea
                              ...
                              cols="30"
                              rows="10"
                              class="rounded-3xl border-2 border-[#e6e6e6] bg-[#f9f9f9] placeholder:text-center placeholder:font-light text-center p-3"
                            ...
                            <div class="flex justify-center">
                              <button
                                class="text-white bg-[#e6e6e6] px-8 py-2 rounded-lg"
                              >
                                PUBLISH
                              </button>
                            </div>
