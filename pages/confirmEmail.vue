<template>
  <div class="flex flex-col justify-center items-center h-screen">
    <form>
      <div>
        <p class="font-poppins text-[36px] text-[#FBF5E3] mb-[92px] text-center">Confirm Email!</p>
      </div>
      <div class="flex justify-center mb-[32px]">
        <img src="~/assets/image/emailSent.svg" alt="" />
      </div>
      <div>
        <p class="font-poppins text-[24px] text-[#FBF5E3] font-light text-center mb-[56px]">
          We’ve sent you an<br />email link! Please verify <br />
          your account
        </p>
      </div>
      ...
      <div class="text-center">
        ...
        <a href="/confirmEmail" class="bg-[#FBF5E3] px-[30px] py-[12px] rounded-[10px] w-[119px] h-[40px] text-[#164D4D] font-inter font-bold">CHECK EMAIL</a>
      </div>
    </form>
  </div>
</template>
