  ...
  <div>
    <header class="shadow-sm bg-[#0C3434]">
      <nav class="container mx-auto h-[79px] flex items-center justify-around">
        <NuxtLink to="/"><p class="text-white font-bold text-xl">glamy beauty</p></NuxtLink>
        <form>
          <div class="flex">
            <div class="relative w-[471px] h-[55px]">
              <input type="search" id="search-dropdown" class="block p-2.5 w-full h-[55px] z-20 text-sm text-gray-900 bg-gray-50 rounded-2xl border-gray-50 border" placeholder="Search for your product" required />
